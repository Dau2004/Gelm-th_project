              ...
              child: ListView(
                children: [
                  _buildStep(
                    ...
                    _qualityResult != null ? 'OK ${_qualityResult!['status']}' : null,
                  ),
                  _buildStep(
                    2,
                    'WHO Z-Score',
                    'Calculating MUAC-for-age Z-score',
                    _zScore != null ? 'OK Z-score: ${_zScore!.toStringAsFixed(2)}' : null,
                  ),
                  _buildStep(
                    3,
                    'Clinical Status',
                    'Determining nutritional status',
                    _clinicalStatus != null ? 'OK $_clinicalStatus' : null,
                  ),
                  _buildStep(
                    4,
                    'AI Recommendation',
                    'Predicting care pathway',
                    _pathwayResult != null ? 'OK ${_pathwayResult!['pathway']}' : null,
                  ),
                  _buildStep(
                    5,
                    'Save Assessment',
                    'Storing to local database',
                    _currentStep > 4 ? 'OK Saved' : null,
                  ),
                ],
              ),
            ),
